...
- [Sprint 1 交付报告](docs/sprints/SPRINT_1.md)

## 🛠️ 技术栈 (Tech Stack)

- **Backend & Agent Orchestration**: Python, LangGraph (选型已确认)
...
**当前状态**：Sprint 1（核心引擎）已完成，Sprint 2（LangGraph 编排与 Actor Agent）进行中。
...
cd worldbox-writer
pip install -e .[dev]
pytest -v  # 运行所有测试 (Sprint 1 覆盖率 99%)
```
