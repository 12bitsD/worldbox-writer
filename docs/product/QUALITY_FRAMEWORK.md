...
Sprint 25 R3 将这些内容与 `WEB_NOVEL_CRITERIA.md`、`docs/sprints/orchestrator/README.md` 的四档表合并为单一真相源 [`QUALITY_SPEC.md`](./QUALITY_SPEC.md)。
...
| 迭代停机规则 | [`docs/sprints/orchestrator/README.md`](../sprints/orchestrator/README.md)（停机规则的归属） |
